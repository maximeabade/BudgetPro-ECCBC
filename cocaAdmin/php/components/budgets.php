<div id="budgets" class="container-fluid bg-fooF" style="color:rgb(253, 253, 253); background-color: black;">
    <div class="row">
        <div class="col-sm-12" style="color: white">
            <h2>BUDGETS</h2><br>
            <h3>Visualiser les budgets, éditez-les ou supprimez-les</h3><br>
        </div>
        <div class="col-sm-4">
            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="budgetsReaderContainer">
                            <!-- This is where your budget data will be displayed -->
                        </div>
                    </div>
                </div>
            </div>
